    ...
    <div class="h-full bg-base flex flex-col">
      ...
      <div class="h-8 bg-crust flex items-center px-3 gap-2 border-b border-surface0">
        ...
        <span class="text-xs text-subtext0 ml-2">
          aegis-project - Visual Studio Code
        </span>
      </div>
      ...
      <div class="flex-1 flex">
        ...
        <div class="w-40 bg-mantle border-r border-surface0 text-xs">
          <div class="px-3 py-2 text-overlay0 uppercase font-semibold text-[10px]">
            Explorer
          </div>
          <div class="px-2">
            <div class="text-subtext0 py-1"> AEGIS-PROJECT</div>
            <div class="ml-3 space-y-0.5">
              <div class="text-overlay1 py-0.5 hover:bg-surface0 px-1 rounded">
                {" "}
                src
              </div>
              <div class="ml-3 text-text py-0.5 px-1 bg-surface0 rounded border-l-2 border-mauve">
                {" "}
                main.rs
              </div>
              <div class="text-overlay1 py-0.5 hover:bg-surface0 px-1 rounded">
