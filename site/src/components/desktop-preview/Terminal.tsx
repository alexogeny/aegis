...
function NeofetchOutput() {
  return (
    <div class="text-xs leading-relaxed mt-2 flex gap-4">
      {/* ASCII Art */}
      <pre
        class="text-blue whitespace-pre"
...
/_-''    ''-_\\`}
      ...
      <div class="text-xs space-y-0.5">
        <div>
          <span class="text-mauve font-bold">aegis</span>@
          <span class="text-mauve font-bold">aegis</span>
        </div>
        <div class="text-overlay0">---------------</div>
        <div>
          <span class="text-mauve font-bold">OS</span>: Aegis Linux x86_64
        </div>
        <div>
          <span class="text-mauve font-bold">Kernel</span>: 6.12.8-arch1-1
        </div>
        <div>
          <span class="text-mauve font-bold">WM</span>: Hyprland
        </div>
        <div>
          <span class="text-mauve font-bold">Theme</span>: Catppuccin Mocha
        </div>
        <div>
          <span class="text-mauve font-bold">Terminal</span>: kitty
        </div>
        <div>
          <span class="text-mauve font-bold">Shell</span>: fish 3.7.1
        </div>
...
export function Terminal({
  ...
  return (
    <div
      class="h-full bg-base p-3 font-mono text-text overflow-hidden"
      style={{ fontSize: "12px" }}
    >
      {lines.map((line, i) => (
        <div key={i}>
