  ...
  return (
    <div class="absolute top-2 left-3 right-3 h-10 bg-base/85 backdrop-blur-sm rounded-xl border-2 border-surface0 flex items-center justify-between px-3 font-mono text-sm font-semibold z-20">
      ...
      <div class="flex items-center gap-2">
        {/* Launcher */}
        <button class="text-mauve text-lg px-3 py-1 rounded-lg bg-surface0 hover:bg-surface1 transition-colors"></button>
      ...
      {/* Center - Window Title */}
      <div class="text-subtext1 text-xs hidden sm:block">kitty</div>

      {/* Right - System Tray */}
      <div class="flex items-center gap-1">
        <div class="px-3 py-1 rounded-lg bg-surface0 text-sky"></div>
        <div class="px-3 py-1 rounded-lg bg-surface0 text-teal"></div>
        <div class="px-3 py-1 rounded-lg bg-surface0 text-green"></div>
        <div class="px-3 py-1 rounded-lg bg-surface0 text-rosewater">
          {time}
        </div>
        <button class="px-3 py-1 rounded-lg bg-surface0 text-red hover:bg-red hover:text-base transition-colors"></button>
      </div>
    </div>
  );
}
